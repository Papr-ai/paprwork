...
echo "This will: code sign -> create PKG -> notarize with Apple -> staple ticket"
...
echo "============================================"
echo ""
ls -lh release/*.pkg release/*.zip 2>/dev/null || echo "(No PKG/ZIP found - check release/ directory)"
echo ""
echo "Next steps:"
...
echo "  3. Upload PKG to website for distribution"
