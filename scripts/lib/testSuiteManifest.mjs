...
export const TEST_STEPS = [
  ...
  {
    id: "turso-option-a-e2e",
    name: "Option A Turso naming E2E (publisher base / visitor suffix)",
    tiers: ["local", "cloud", "full"],
    npmScript: "test:turso-option-a-e2e",
    command: null,
    requires: [],
    optional: true,
  },
  {
    id: "turso-option-a-cloud-host-e2e",
    name: "Option A cloud host E2E (owner vs visitor db-token allowlist)",
    tiers: ["local", "cloud", "full"],
    npmScript: "test:turso-option-a-cloud-host-e2e",
    command: null,
    requires: ["memory", "cloudAppHost"],
    optional: true,
  },
  {
    id: "jobs-e2e",
  ...
  {
    id: "replica-migration-cloud-e2e",
    name: "Plan A migration → push → cloud verify E2E",
    tiers: ["cloud", "full"],
    npmScript: "test:replica-migration-cloud-e2e",
    command: null,
    requires: ["auth"],
    optional: true,
  },
  {
    ...
    name: "Plan A Turso replica production E2E",
    tiers: ["cloud", "full"],
  ...
  },
  {
    ...
    name: "Plan A replica cutover E2E (spikes 14–17)",
    tiers: ["cloud", "full"],
  ...
  },
  {
    ...
    name: "Plan A replica connect-flap spike (#5)",
    tiers: ["cloud", "full"],
