...
Every mini-app MUST have a simple SVG icon — it appears in tabs, the apps list, and favorites.

**✅ GOOD icons:**
- Simple, recognizable SVGs (1-3 shapes max)
- Use \`stroke="currentColor"\` with \`stroke-width="1.5"\` or \`"2"\` for theme compatibility
