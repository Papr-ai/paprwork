          ...
          {shouldLoadLocalIframe || (isPublishedPreview && iframeSrc) ? (
            ...
            <iframe
              ...
              onLoad={() => {
                ...
                // Isolated origin: the document is unreadable, so wait for the
                // bridge to announce instead. Silence past the grace window
                // means the response was not ours (an unregistered route) —
                // retry, which is what that case needs.
