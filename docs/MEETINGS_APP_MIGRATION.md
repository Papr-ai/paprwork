...
- Meetings stored in JSON file (`$PAPR_HOME/data/meetings.json`)
...
- Located at `$PAPR_HOME/apps/ea6d8d7c-a15e-4c02-8273-117450b498f4/`
...
```
$PAPR_HOME/apps/ea6d8d7c-a15e-4c02-8273-117450b498f4/
...
If users had meetings data in the old format (`$PAPR_HOME/data/meetings.json`), they would need to:
